package com.abilix.robot.iflytek;
...
import com.abilix.robot.DataConfig;
import com.abilix.robot.base.BaseService;
import com.abilix.robot.iflytek.util.GsonParse;
import com.abilix.robot.iflytek.util.IflyUtils;
import com.abilix.robot.turing.api.TuringService;
...
public class VTTService extends BaseService {
    ...
    private RecognizerListener mRecognizerListener = new RecognizerListener() {
        ...
        public void onResult(RecognizerResult results, boolean isLast) {
            ...
            Call<VoiceResultInfo> call = apiService.send(result, "001");
